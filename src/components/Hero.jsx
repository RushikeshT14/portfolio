...
const Hero = () => {
    return (
        <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[90vh-6rem]">
            ...
            <div className="max-w-xl ml-[5%] z-10 mt-[90%] md:mt-[60%] lg:mt-[5%]" data-aos="fade-right"
                ...
                <div className=" relative w-full w-[95%] sm:w-48 h-10 bg-gradient-to-r from-[#656565] to-[#e99b63] shadow-[0_0_15px_rgba(255,255,255,0.4)] rounded-full">
                ...
                <div className="flex gap-4 mt-12">
                    ...
                    <a href="#" className="border border-[#2a2a2a] py-2 sm:py-3 px-8 sm:px-10 rounded-full sm:text-lg  text-sm font-semibold tracking-wider transition-all duration-1000 hover:bg-[#1a1a1a] bg-gray-300 text-black hover:text-white">
