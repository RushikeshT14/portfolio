    ...
    <div id="Projects">
      ...
      <div className="Projects">
          ...
          >
            <div className="ProjectCard">
              ...
              <p>
                ...
                with mobile view still under development.
              </p>
              <div>
                <i class="fa-brands fa-react"></i>
                <i class="fa-solid fa-database"></i>
        ...
        <div className="ProjectsRightCon">
          ...
          >
            <div className="ProjectCard">
              <a href="https://www.rhythmandtunes.in/" target="_blank">
              Rhythm & Tunes &#8592;{" "}
              </a>
              <p>A modern and responsive website for a professional music academy. The platform showcases various music courses, instruments, and training programs in a clean and user-friendly way. I focused on creating an engaging UI/UX with smooth navigation, responsive layouts, and optimized performance across all devices. I also worked on improving accessibility, loading speed, and overall user experience to make the site both visually appealing and functional. 
              </p>
              <div>
                <i class="fa-brands fa-html5"></i>
                <i class="fa-brands fa-css"></i>
